          ...
          <div class="col-xs-12">
            <div class="box">
              <div class="box-header">
                ...
                <a href="{{ route('account_type.create') }}"><button type="button" class="btn btn-primary"><i class="fa fa-plus"></i> Add New</button></a>
              ...
              <div class="box-body">
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <tbody>
                  <?php $no = 0; foreach ($account_type as $key => $value) { $no++; ?>
  	                <tr>
                      <td>{{ $no }}</td>  	                                                
